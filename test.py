...
cftc_eur = [-46764, - 44951, - 45713, - 52348, - 66500, - 65823, - 70056, - 69408, - 78045, - 87513, - 114556, - 119240,
            - 119348, - 119182, - 129314, - 137385, - 123856, - 109268, - 93472, - 82059, - 76030, - 85025, - 81475,
            - 92630, - 81925, - 76658, - 92508, - 98399, - 104103, - 112600, - 99891, - 87660, - 75327, - 61934,
            - 61346, - 56489, -67112, - 37654, - 37895, - 22587, - 21872, - 23619, - 39667, - 46917, - 52051, - 53487,
            - 63811, - 66053, - 77555, - 71907, - 68541, - 46857, - 48205, - 63314, - 87073, - 127215, - 137015,
            - 146451, - 160643,
            - 160550, - 161047, - 159961, - 172331, - 182845, - 175484, - 164177, - 142939, - 134334, - 105934, - 62566,
            - 80576, - 88810]

cftc_usd = [45861, 46733, 46572, 48422, 49122, 53128, 54271, 52644, 52367, 56712, 54602, 53403, 53189, 48428, 52296,
            54330, 53990, 45422, 33549, 12100, 12205, 14400, 17074, 16961, 14966, 15968, 16471, 15769, 17717, 22479,
            14526, 13984, 12279, 12179, 9372,
            4692, 9799, 9906, 11178, 10446, 12117, 9174, 11330, 13449, 13849,
            17315, 17750, 17674, 17511, 26378, 26785, 29425, 31342, 35013, 44872, 44225,
            42775, 42719, 40709, 33615, 33407, 36902, 51028, 47337, 46146, 46527, 43784, 39926, 34691, 28203, 38875,
            45991
            ]
def test():
    fig = plt.figure()
    ...
    cftc_eur =  [    -46764,    - 44951,    - 45713,    - 52348,    - 66500,    - 65823,    - 70056,- 69408,    - 78045,    - 87513,    - 114556,        - 119240,    - 119348,    - 119182,    - 129314,   - 137385,    - 123856,    - 109268,    - 93472,        - 82059,    - 76030,    - 85025,    - 81475,
                - 92630,    - 81925,    - 76658,    - 92508,        - 98399,    - 104103,    - 112600,    - 99891,- 87660,    - 75327,    - 61934,    - 61346,    - 56489,  -67112,      - 37654,    - 37895,     - 22587,  - 21872,   - 23619,    - 39667,- 46917,     - 52051,- 53487,
    ...
    cftc_usd=[45861,46733,46572,48422,49122,53128,54271,52644,52367,56712,54602,53403,53189,48428,52296, 54330,53990,45422,33549,12100,12205,14400,17074,16961,14966,15968,16471,15769,                17717,22479,14526,13984,12279,12179,9372,
              4692,              9799,              9906,              11178,              10446,              12117,              9174,              11330,              13449,  13849,
              17315,              17750,              17674,              17511,              26378,              26785,              29425,              31342,              35013,              44872,              44225,
    ...
    df = pd.DataFrame({'date':date,'diff':cftc_eur})
    print (df)
    return
...
def pandas_draw():
    ...
    plt.show()
def drawExchange():
    cftc_eur = [-46764, - 44951, - 45713, - 52348, - 66500, - 65823, - 70056, - 69408, - 78045, - 87513, - 114556,
                - 119240, - 119348, - 119182, - 129314, - 137385, - 123856, - 109268, - 93472, - 82059, - 76030,
                - 85025, - 81475,
                - 92630, - 81925, - 76658, - 92508, - 98399, - 104103, - 112600, - 99891, - 87660, - 75327, - 61934,
                - 61346, - 56489, -67112, - 37654, - 37895, - 22587, - 21872, - 23619, - 39667, - 46917, - 52051,
                - 53487,
                - 63811, - 66053, - 77555, - 71907, - 68541, - 46857, - 48205, - 63314, - 87073, - 127215, - 137015,
                - 146451, - 160643,
                - 160550, - 161047, - 159961, - 172331, - 182845, - 175484, - 164177, - 142939, - 134334, - 105934,
                - 62566, - 80576, - 88810]
    date = pd.date_range('2015.10.6', periods=72, freq='W-TUE')
    cftc_eur.reverse()
    df_cftc = pd.DataFrame({'date': date, 'diff_eur': cftc_eur})

    cftc_usd.reverse()
    df_cftc_usd = pd.DataFrame({'date': date, 'diff_usd': cftc_usd})
    ...
    for row in csv_reader:
        df2= pd.DataFrame([[parse(row[0]), row[1], row[2], row[3], row[4], row[5], row[6]]], columns=df.columns)
        # print("df2:\n",df2)
        df=df.append(df2, ignore_index=True)
        # df.append({'date':row[0],'time':row[1],'open':row[2],'high':row[3],'low':row[4],'close':row[5],'volume':row[6]},ignore_index=True)

    df = pd.merge(df_cftc_usd,df,on='date')
    print(df)
    # return
    ...
    plt.ylabel('value')
    ax2 = ax1.twinx()
    plt.plot( df['date'],df['diff_usd'], 'r')
    plt.ylabel('diff')
    plt.show()
